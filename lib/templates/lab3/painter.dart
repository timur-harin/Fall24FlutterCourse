...
class WaterProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final waterLevel = size.height * waterIntakeLevel / 10;
    final waterConstraint = waterLevel.clamp(0.0, size.height);
    ...
    canvas.drawRect(
      Rect.fromLTRB(0, size.height - waterConstraint, size.width, size.height),
      paint,
    );
  }
