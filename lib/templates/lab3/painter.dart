...
class WaterProgressPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    // Using size and waterIntakeLevel to calculate the water level
    final double waterLevel = size.height * waterIntakeLevel;

    final paint = Paint()
      ..color = Colors.blueAccent.withOpacity(0.5)
      ..style = PaintingStyle.fill;

    // Draw the water level on the canvas using rectangle and size from waterLevel
    canvas.drawRect(
