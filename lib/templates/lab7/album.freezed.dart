...
/// @nodoc
mixin _$Album {
  int get userId => throw _privateConstructorUsedError; // User ID of the album
  int get id => throw _privateConstructorUsedError; // Album ID
...
abstract class _Album implements Album {
  const factory _Album(
      ...
      required final String title}) = _$AlbumImpl;

  factory _Album.fromJson(Map<String, dynamic> json) = _$AlbumImpl.fromJson;

  @override
  int get userId; // User ID of the album
  @override
  int get id; // Album ID
  @override
  String get title;
